...
/**
 * @author: tuacy
 * @date: 2015/9/16 17:23
 * @version: V1.0
 */
public class NavigationViewDownActivity  extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_navigationview_down);
		initView();
	}
					...
					Snackbar.make(getCurrentFocus(), "click" + menuItem.getTitle(), Snackbar.LENGTH_SHORT)
							.setAction("Right", new View.OnClickListener() {
								...
								public void onClick(View v) {
									Toast.makeText(NavigationViewDownActivity.this, "Yes", Toast.LENGTH_SHORT).show();
								}
							})
							.show();
					break;
